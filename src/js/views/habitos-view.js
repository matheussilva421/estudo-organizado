...
import { esc, formatDate, todayStr, uid, HABIT_TYPES, addCleanupListener } from '../utils.js?v=8.20';
import { state, scheduleSave } from '../store.js?v=8.20';
import { getAllDisciplinas, getDisc } from '../logic.js?v=8.20';
import { renderCurrentView } from '../components.js?v=8.20';
import { showConfirm, showToast, openModal } from '../app.js?v=8.20';
