...
import * as store from './store.js?v=8.22';
import * as app from './app.js?v=8.22';
import * as logic from './logic.js?v=8.22';
import * as components from './components.js?v=8.22';
import * as views from './views.js?v=8.22';
import * as calendar_view from './views/calendar-view.js?v=8.22';
import * as drive_sync from './drive-sync.js?v=8.22';
import * as cloud_sync from './cloud-sync.js?v=8.22';
import * as registro from './registro-sessao.js?v=8.22';
import * as utils from './utils.js?v=8.22';
import * as wizard from './planejamento-wizard.js?v=8.22';

import * as relevance from './relevance.js?v=8.22';
import * as lesson_mapper from './lesson-mapper.js?v=8.22';
import * as firestore_sync from './sync/firestore-sync-engine.js?v=8.22';

// Import UI helpers and action dispatcher
import { setupActionDispatcher } from './ui/actions/index.js?v=8.22';
import { qs, qsa } from './ui/dom.js?v=8.22';
import { initModals, announce } from './ui/dialog.js?v=8.22';
import { addCleanupListener } from './utils.js?v=8.22';
