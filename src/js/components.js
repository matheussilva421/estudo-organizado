import { currentView } from './app.js?v=8.33';
import {
  formatDate,
  formatTime,
  getEventStatus,
...
import { renderCalendar } from './views/calendar-view.js?v=8.33';
...
import { getActiveDashboardDiscCtx } from './state/dashboard-context.js?v=8.33';
import {
  getDiscChartInstance,
  setDiscChartInstance,
  getPlanjChartInstance,
  setPlanjChartInstance,
} from './state/chart-state.js?v=8.33';
    ...
    setTimeout(() => {
      if (currentView === 'home') renderHome(el);
        ...
        if (getActiveDashboardDiscCtx()) {
          ...
          import('./views.js?v=8.33').then(({ openDiscDashboard }) =>
