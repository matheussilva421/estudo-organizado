import { currentView } from './app.js?v=8.32';
import {
  formatDate,
  formatTime,
  getEventStatus,
...
import { renderCalendar } from './views/calendar-view.js?v=8.32';
...
import { getActiveDashboardDiscCtx } from './state/dashboard-context.js?v=8.32';
import {
  getDiscChartInstance,
  setDiscChartInstance,
  getPlanjChartInstance,
  setPlanjChartInstance,
} from './state/chart-state.js?v=8.32';
    ...
    setTimeout(() => {
      if (currentView === 'home') renderHome(el);
        ...
        if (getActiveDashboardDiscCtx()) {
          ...
          import('./views.js?v=8.32').then(({ openDiscDashboard }) =>
