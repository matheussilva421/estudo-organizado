...
import { esc, todayStr, trunc, uid, getEventStatus, addCleanupListener } from '../utils.js?v=8.29';
import { getDisc, getActiveDisciplinas, reattachTimers } from '../logic.js?v=8.29';
