...
import {
  ...
  savePastEvent,
  openEventDetail,
} from '../../ui/event-modals.js?v=8.32';
import { showConfirm, closeModal } from '../../app.js?v=8.32';
import { deleteEvento, marcarEstudei } from '../../logic.js?v=8.32';
import { clearSearch } from '../../views.js?v=8.32';
import {
  openRegistroSessao,
  cancelRegistro,
  discardTimerUI,
...
} from '../../registro-sessao.js?v=8.32';
...
registerAction('switch-to-event-timer', (el) => {
  ...
  import('../../app.js?v=8.32').then(({ navigate }) => {
    navigate(view);
    setTimeout(() => {
      if (eventId) toggleTimer(eventId);
    }, 100);
