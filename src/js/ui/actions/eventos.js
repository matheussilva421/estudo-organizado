...
import {
  ...
  savePastEvent,
  openEventDetail,
} from '../../ui/event-modals.js?v=8.31';
import { showConfirm, closeModal } from '../../app.js?v=8.31';
import { deleteEvento, marcarEstudei } from '../../logic.js?v=8.31';
import { clearSearch } from '../../views.js?v=8.31';
import {
  openRegistroSessao,
  cancelRegistro,
  discardTimerUI,
...
registerAction('switch-to-event-timer', (el) => {
  ...
  import('../../app.js?v=8.31').then(({ navigate }) => {
    navigate(view);
    setTimeout(() => {
      if (eventId) toggleTimer(eventId);
    }, 100);
