...
import {
  ...
  pwToggleDay,
  pwUpdateDayHour,
} from '../../planejamento-wizard.js?v=8.34';
import {
  recomecarCiclo,
  zerarCiclosCounter,
...
import { desfazerEtapa, iniciarEtapaPlanejamento } from '../../logic.js?v=8.34';
...
import { openEventDetail } from '../../ui/event-modals.js?v=8.34';
