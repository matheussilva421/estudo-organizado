...
export async function loadAppModules() {
  ...
  const logic = await import('../../src/js/logic.js?v=8.19');
  const app = await import('../../src/js/app.js?v=8.19');
  const components = await import('../../src/js/components.js?v=8.19');
  const views = await import('../../src/js/views.js?v=8.19');
