...
export async function loadAppModules() {
  ...
  const store = await import('../../src/js/store.js?v=8.29');
  const logic = await import('../../src/js/logic.js?v=8.29');
  const app = await import('../../src/js/app.js?v=8.29');
  const components = await import('../../src/js/components.js?v=8.29');
  const views = await import('../../src/js/views.js?v=8.29');
