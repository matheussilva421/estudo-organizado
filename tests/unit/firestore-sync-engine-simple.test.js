...
describe('firestore-sync-engine.js', () => {
  ...
  describe('getFirestoreSyncStatus()', () => {
    it('returns status with configured=false when Firebase not configured', async () => {
      vi.doMock('../firebase/firebase-client.js?v=8.29', () => ({
