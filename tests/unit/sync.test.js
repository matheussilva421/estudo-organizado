...
vi.mock('../../src/js/credentials.js?v=8.21', () => ({
...
vi.mock('../../src/js/components.js?v=8.21', () => ({
  renderCurrentView: vi.fn()
}));

// Mock parcial de utils.js - mantém todas as funções originais, mocka apenas uid para teste
vi.mock('../../src/js/utils.js?v=8.21', async () => {
  const actual = await vi.importActual('../../src/js/utils.js?v=8.21');
  let counter = 0;
  return {
    ...actual,
...
beforeEach(async () => {
  ...
  utils = await import('../../src/js/utils.js?v=8.21');
});
...
describe('credentials.js', () => {
  describe('setCredential()', () => {
    it('salva credencial no IndexedDB', async () => {
      const { setCredential } = await import('../../src/js/credentials.js?v=8.21');
  ...
  describe('getCredential()', () => {
    it('recupera credencial do IndexedDB', async () => {
      const { getCredential } = await import('../../src/js/credentials.js?v=8.21');
  ...
  describe('deleteCredential()', () => {
    it('remove credencial do IndexedDB', async () => {
      const { deleteCredential } = await import('../../src/js/credentials.js?v=8.21');
