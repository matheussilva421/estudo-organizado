...
describe('poll-firestore-remote (TDD - RED phase)', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('../../src/js/sync/firestore-sync-engine.js?v=8.33');
  ...
  describe('pollFirestoreRemote()', () => {
    it('applies remote state when remote is newer', async () => {
      const { readFirestoreSnapshot } = await import('../../src/js/sync/firestore-repository.js?v=8.33');
      const { applyEnvelopeToLocalState } = await import('../../src/js/sync/firestore-schema.js?v=8.33');
      const { setState } = await import('../../src/js/store.js?v=8.33');
    ...
    it('calls saveStateToDB with skipFirestoreSync after applying remote state', async () => {
      const { readFirestoreSnapshot } = await import('../../src/js/sync/firestore-repository.js?v=8.33');
      const { saveStateToDB } = await import('../../src/js/store.js?v=8.33');
