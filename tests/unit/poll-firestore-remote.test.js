...
describe('poll-firestore-remote (TDD - RED phase)', () => {
  ...
  beforeEach(async () => {
    ...
    vi.doMock('../../src/js/sync/sync-health.js?v=8.32', () => ({
    ...
    vi.doMock('../../src/js/sync/sync-lock.js?v=8.32', () => ({
    ...
    const module = await import('../../src/js/sync/firestore-sync-engine.js?v=8.32');
  ...
  describe('pollFirestoreRemote()', () => {
    it('applies remote state when remote is newer', async () => {
      const { readFirestoreSnapshot } = await import('../../src/js/sync/firestore-repository.js?v=8.32');
      const { applyEnvelopeToLocalState } = await import('../../src/js/sync/firestore-schema.js?v=8.32');
      const { setState } = await import('../../src/js/store.js?v=8.32');
    ...
    it('calls saveStateToDB with skipFirestoreSync after applying remote state', async () => {
      const { readFirestoreSnapshot } = await import('../../src/js/sync/firestore-repository.js?v=8.32');
      const { saveStateToDB } = await import('../../src/js/store.js?v=8.32');
