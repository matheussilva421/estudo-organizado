...
describe('CSS architecture', () => {
  ...
  it('keeps browser cache busting aligned with the current app version', () => {
    ...
    expect(html).toContain('css/styles.css?v=9.23');
    expect(serviceWorker).toContain("APP_VERSION = '9.23'");
    expect(syncDiagnostic).toContain("DIAGNOSTIC_BUILD_VERSION = '9.23'");
