...
describe('ui/dialog.js', () => {
  ...
  describe('openModal()', () => {
    it('warns when modal not found', async () => {
      const { openModal } = await import('../../src/js/ui/dialog.js?v=8.33');
  ...
  describe('closeModal()', () => {
    it('hides modal and sets aria-hidden to true', async () => {
      ...
      const { openModal, closeModal } = await import('../../src/js/ui/dialog.js?v=8.33');
      openModal('modal-test');
    ...
    it('does nothing when modal not found', async () => {
      const { closeModal } = await import('../../src/js/ui/dialog.js?v=8.33');
  ...
  describe('initModals()', () => {
    it('sets ARIA attributes on modals', async () => {
      ...
      const { initModals } = await import('../../src/js/ui/dialog.js?v=8.33');
      initModals();
  ...
  describe('announce()', () => {
    it('warns when announcer not found', async () => {
      const { announce } = await import('../../src/js/ui/dialog.js?v=8.33');
      const warnSpy = vi.spyOn(console, 'warn').mockImplementation(() => {});
