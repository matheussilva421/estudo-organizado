...
vi.mock('../../src/js/credentials.js?v=8.36', () => ({
...
vi.mock('../../src/js/components.js?v=8.36', () => ({
  renderCurrentView: vi.fn(),
}));

// Mock de sync-center.js
vi.mock('../../src/js/sync/sync-center.js?v=8.36', () => ({
...
beforeEach(async () => {
  ...
  driveSync = await import('../../src/js/drive-sync.js?v=8.36');
  credentials = await import('../../src/js/credentials.js?v=8.36');
  app = await import('../../src/js/app.js?v=8.36');
  store = await import('../../src/js/store.js?v=8.36');
